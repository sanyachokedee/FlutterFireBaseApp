          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Column(
                ...
                children: <Widget>[
                  TextField(
                    //controller มาเพื่อทำการรับค่าจาก ที่ป้อน otp
  ...
  Future signInWithFacebook(BuildContext context) async {
    ...
    switch (result.status) {
      ...
      case FacebookLoginStatus.cancelledByUser:
        BottomSheetWidget()
            .bottomSheet(context, "มีข้อผิดพลาด", "ผู้ใช้ยกเลิกการเข้าใช้งาน");
        break;
      case FacebookLoginStatus.error:
        BottomSheetWidget().bottomSheet(context, "มีข้อผิดพลาด",
            "มีข้อผิดพลาด ${result.errorMessage} ในระหว่างการเข้าใช้งาน");
        break;
    }
  }
  ...
  Future firebaseSignIn(
    ...
    try {
      ...
      if (e.code == 'invalid-email') {
        BottomSheetWidget()
            .bottomSheet(context, "มีข้อผิดพลาด", "ป้อนอีเมล์ไม่ถูกต้อง");
  ...
  Future firebaseRegister(
    ...
    try {
      ...
      if (e.code == 'weak-password') {
        BottomSheetWidget().bottomSheet(
            context, "มีข้อผิดพลาด", "รหัสผ่านสั้นหรือง่ายเกินไป ไม่ปลอดภัย");
      } else if (e.code == 'email-already-in-use') {
        BottomSheetWidget().bottomSheet(context, "มีข้อผิดพลาด",
            "มีบัญชีนี้อยู่แล้วในระบบ ลองใช้อีเมล์อื่น");
      } else if (e.code == 'invalid-email') {
        BottomSheetWidget()
            .bottomSheet(context, "มีข้อผิดพลาด", "รูปแบบอีเมล์ไม่ถูกต้อง");
      }
      return false;
    } catch (e) {
      print(e);
